...
import it.opensource.indovinanumero.TestFXJUnitAppRunner;
...
public class SimpleTestFXJUnitTest extends TestFXJUnitAppRunner {
    ...
    private final String TEXT_LABEL_BEFORE_CLICK = "Nuova Partita";

    private final String TEXT_LABEL_AFTER_CLICK  = "Nuova Partita";
